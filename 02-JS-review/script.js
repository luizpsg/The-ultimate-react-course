...
const summary = `${title} is a book with ${pages} pages, was writther by ${author} and was published on ${getYear(
  publicationDate
)}. The book has ${hasMovieAdaptation ? "" : "no "}movie adaptation.`;
console.log(summary);
...
console.log("luiz" && "some string");
console.log(0 && "some string");

console.log(true || "some string");
console.log(false || "some string");
console.log(hasMovieAdaptation || "The book has no movie adaptation");
...
// const countWrong = book.reviews.librarything.reviewsCount || "nodata";
...
const booksAfterDelete = booksAfterAdd.filter((book) => book.title !== "Dune");
booksAfterDelete;

//3) Update a book object from array
